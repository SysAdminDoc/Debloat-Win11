...
- Test mocks use Pester's `Should -Invoke` syntax; the 124-test suite passes under Pester 5.9 and 6.0 on PowerShell 7 and under Windows PowerShell 5.1 with Pester 5.9.
